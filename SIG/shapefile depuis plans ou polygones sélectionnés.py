...
def main() -> None:
    ...
    if not doc.GetActiveObjects(0):
        c4d.gui.MessageDialog("Vous devez sélectionner des plans")
        return
    fn_shp = c4d.storage.SaveDialog()
    if not fn_shp[-4:] == '.shp':
        fn_shp+='.shp'
    ...
    #fn_shp = '/Users/olivierdonze/Documents/Mandats/Vallee du Trient/C4D/calage_travaux_etu/tex/bachelor_2022_polygones_plans_masses.shp'
